Task 0, C program assigns a random number to the variable n each time it is executed.
...
Task 3, C program that prints the alphabet in lowercase, and then in uppercase, followed by a new line.
